...
public class TextTagWeightComparer implements Comparator<TextTag> 
{
    public int compare(TextTag x, TextTag y) {
        return x.getWeight() == y.getWeight() ? 0 : (x.getWeight() < y.getWeight() ? -1 : 1);
    }
