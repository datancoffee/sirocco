...
public class POSTaggerFactory extends opennlp.tools.postag.POSTaggerFactory {
	...
	public POSTaggerFactory(Dictionary ngramDictionary, TagDictionary posDictionary) {
		POSTagDictionary tagDictionary = new POSTagDictionary(posDictionary);
		super.init(ngramDictionary, tagDictionary);
	}
