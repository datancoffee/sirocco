...
public class BaseformOverrideDictionary  extends GenericDictionary<StringVector> 
{
    public BaseformOverrideDictionary(InputStream dictionarystream) throws Exception {
